...
export const UPDATE_ACTIVE_EMPLOYEE = "[Auth] UPDATE_ACTIVE_EMPLOYEE";
...
export class AuthSuccess implements Action {
  ...
  constructor(public payload: { employee: Employee, redirect: boolean }){}
}

export class UpdateActiveEmployee implements Action {
  readonly type = UPDATE_ACTIVE_EMPLOYEE;
